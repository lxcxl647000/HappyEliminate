...
export class Constants {
    ...
    static SCREEN_HEIGHT : number = 1136;

    // 消除区域大小
    static GRID_SIZE_WIDTH : number = 8; // 地图大小，每行每列多少个
    static GRID_SIZE_HEIGHT : number = 8; // 地图大小，每行每列多少个
    static GRID_SIZE_MAX : number = 10; // 地图大小，每行最多多少个

    static GRID_WIDTH : number = 600;
