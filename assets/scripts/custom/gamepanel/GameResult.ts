import { _decorator, Animation, Component, instantiate, Label, Node, Sprite, UITransform } from 'cc';
...
export class GameResult extends Component {
    ...
    setStarCount(count: number) {
        ...
        this.star1.index = count >= 1 ? 0 : 1;
        this.star2.index = count >= 2 ? 0 : 1;
        this.star3.index = count >= 3 ? 0 : 1;
    }
    ...
    addStepsByGold() {
        if (PlayerMgr.ins.userInfo.props.integral < GameConstant.Steps_Cost_Gold) {
